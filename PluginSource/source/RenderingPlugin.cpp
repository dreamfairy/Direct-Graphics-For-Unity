...
static void UNITY_INTERFACE_API OnRenderEventAndData(int eventID, void* data)
{
    switch(eventID)
    {
        ...
        case event_DrawMesh:
            ...
            s_CurrentAPI->DrawMesh(g_DrawMeshData->vertexBuffer, g_DrawMeshData->indexBuffer,
                                   g_DrawMeshData->uvBuffer,
                                   g_DrawMeshData->textureBuffer,
                g_DrawMeshData->localToWorld,
